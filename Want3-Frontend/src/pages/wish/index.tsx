...
import { getContractAddress, sepolia_contractAddress } from 'config/constants'
...
const Page: React.FC = () => {
  ...
  const contractAddress = getContractAddress(chain?.chainId ?? 1442)
  ...
  return (
    <Content>
      ...
      <Right>
        ...
        <HintLabel>
          Your wish will appear in the preview once you submit it.
        </HintLabel>
